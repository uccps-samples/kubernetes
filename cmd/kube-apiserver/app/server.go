...
import (
	...
	"k8s.io/kubernetes/uccp-kube-apiserver/admission/admissionenablement"
	"k8s.io/kubernetes/uccp-kube-apiserver/enablement"
	"k8s.io/kubernetes/uccp-kube-apiserver/uccpkubeapiserver"
...
cluster's shared state through which all other components interact.`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if len(s.OpenShiftConfig) > 0 {
				...
				args, err := uccpkubeapiserver.ConfigToFlags(openshiftConfig)
				if err != nil {
					return err
				}
...
func buildGenericConfig(
	...
	if err := uccpkubeapiserver.OpenShiftKubeAPIServerConfigPatch(genericConfig, versionedInformers, &pluginInitializers); err != nil {
