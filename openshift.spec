...
Obsoletes:      atomic-uccp-hyperkube <= %{version}
Obsoletes:      atomic-uccp-node <= %{version}
...
install -p -m 755 uccp-hack/images/hyperkube/hyperkube %{buildroot}%{_bindir}/hyperkube
