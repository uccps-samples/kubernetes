...
var (
	...
	pinnedManagementFilename  = "/etc/kubernetes/uccp-workload-pinning"
	WorkloadsAnnotationPrefix = "target.workload.uccp.io/"
	WorkloadsCapacitySuffix   = "workload.uccp.io/cores"
	ContainerAnnotationFormat = "resources.workload.uccp.io/%v"
)
