...
readonly OS_GO_PACKAGE=github.com/uccps-samples/origin
...
function os::util::list_go_deps() {
  go list -f '{{.ImportPath}}{{.Imports}}' ./test/... ./pkg/... ./cmd/... ./vendor/k8s.io/... | tr '[]' '  ' |
    sed -e 's|github.com/uccps-samples/origin/vendor/||g' |
...
EOF
  goversioninfo -o ${OS_ROOT}/vendor/github.com/uccps-samples/oc/cmd/oc/oc.syso ${windows_versioninfo_file}
}
...
function os::build::clean_windows_versioninfo() {
  rm ${OS_ROOT}/vendor/github.com/uccps-samples/oc/cmd/oc/oc.syso
}
