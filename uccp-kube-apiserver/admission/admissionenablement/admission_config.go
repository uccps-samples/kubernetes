...
import (
	...
	"github.com/uccps-samples/library-go/pkg/apiserver/admission/admissiontimeout"
	"k8s.io/apimachinery/pkg/labels"
	"k8s.io/apiserver/pkg/admission"
	"k8s.io/client-go/informers"
	"k8s.io/client-go/kubernetes"
	"k8s.io/kubernetes/cmd/kube-apiserver/app/options"
	"k8s.io/kubernetes/uccp-kube-apiserver/admission/namespaceconditions"
)

const disableSCCLevelLabel = "security.uccp.io/disable-securitycontextconstraints"
...
func SetAdmissionDefaults(o *options.ServerRunOptions, informers informers.SharedInformerFactory, kubeClient kubernetes.Interface) {
	...
	sccLabelDecorator := namespaceconditions.NewConditionalAdmissionPlugins(
		...
		"security.uccp.io/SecurityContextConstraint", "security.uccp.io/SCCExecRestrictions")

	o.Admission.GenericAdmission.Decorators = append(o.Admission.GenericAdmission.Decorators,
		admission.Decorators{
			// SCC can be skipped by setting a namespace label `security.uccp.io/disable-securitycontextconstraints = true`
