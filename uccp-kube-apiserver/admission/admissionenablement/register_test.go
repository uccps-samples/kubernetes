...
import (
	...
	"github.com/uccps-samples/library-go/pkg/apiserver/admission/admissionregistrationtesting"
...
func TestResourceQuotaBeforeClusterResourceQuota(t *testing.T) {
	...
	expectedOrderedAdmissionSubChain := []string{"ResourceQuota", "quota.uccp.io/ClusterResourceQuota", "AlwaysDeny"}
