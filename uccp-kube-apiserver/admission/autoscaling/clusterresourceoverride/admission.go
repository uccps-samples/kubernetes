...
import (
	...
	v1 "k8s.io/kubernetes/uccp-kube-apiserver/admission/autoscaling/apis/clusterresourceoverride/v1"
	...
	api "k8s.io/kubernetes/uccp-kube-apiserver/admission/autoscaling/apis/clusterresourceoverride"
	"k8s.io/kubernetes/uccp-kube-apiserver/admission/autoscaling/apis/clusterresourceoverride/validation"
)

const (
	clusterResourceOverrideAnnotation = "autoscaling.uccp.io/cluster-resource-override-enabled"
...
var (
	forbiddenNames    = []string{"uccp", "kubernetes", "kube"}
	forbiddenPrefixes = []string{"uccp-", "kubernetes-", "kube-"}
)
