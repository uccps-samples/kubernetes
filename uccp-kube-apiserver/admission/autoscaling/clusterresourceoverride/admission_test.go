...
import (
	...
	clusterresourceoverridev1 "k8s.io/kubernetes/uccp-kube-apiserver/admission/autoscaling/apis/clusterresourceoverride/v1"
...
const (
	yamlConfig = `
apiVersion: autoscaling.uccp.io/v1
