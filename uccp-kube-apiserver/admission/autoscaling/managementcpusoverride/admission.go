...
import (
	...
	configv1informer "github.com/uccps-samples/client-go/config/informers/externalversions/config/v1"
...
const (
	PluginName = "autoscaling.uccp.io/ManagementCPUsOverride"
	...
	containerWorkloadResourceSuffix = "workload.uccp.io/cores"
	...
	namespaceAllowedAnnotation = "workload.uccp.io/allowed"
	// workloadAdmissionWarning contains the admission warning annotation key
	workloadAdmissionWarning = "workload.uccp.io/warning"
	...
	debugSourceResourceAnnotation = "debug.uccp.io/source-resource"
)
