...
import (
	...
	crvalidation "k8s.io/kubernetes/uccp-kube-apiserver/admission/customresourcevalidation"
)

const PluginName = "config.uccp.io/ValidateAuthentication"
...
func toAuthenticationV1(uncastObj runtime.Object) (*configv1.Authentication, field.ErrorList) {
	...
	if !ok {
		return nil, field.ErrorList{
			...
			field.NotSupported(field.NewPath("apiVersion"), fmt.Sprintf("%T", uncastObj), []string{"config.uccp.io/v1"}),
		}
	}
