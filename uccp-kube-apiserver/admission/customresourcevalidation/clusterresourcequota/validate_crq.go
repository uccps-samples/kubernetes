...
import (
	...
	quotavalidation "k8s.io/kubernetes/uccp-kube-apiserver/admission/customresourcevalidation/clusterresourcequota/validation"
)

const PluginName = "quota.uccp.io/ValidateClusterResourceQuota"
