...
const PluginName = "operator.uccp.io/ValidateKubeControllerManager"
...
func toKubeControllerManager(uncastObj runtime.Object) (*operatorv1.KubeControllerManager, field.ErrorList) {
	...
	if !ok {
		return nil, append(allErrs,
			...
			field.NotSupported(field.NewPath("apiVersion"), fmt.Sprintf("%T", uncastObj), []string{"operator.uccp.io/v1"}))
	}
