...
import (
	...
	rbrvalidation "k8s.io/kubernetes/uccp-kube-apiserver/admission/customresourcevalidation/rolebindingrestriction/validation"
)

const PluginName = "authorization.uccp.io/ValidateRoleBindingRestriction"
