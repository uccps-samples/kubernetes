...
const DefaultingPluginName = "security.uccp.io/DefaultSecurityContextConstraints"
...
func (a *defaultSCC) shouldIgnore(attributes admission.Attributes) bool {
	if attributes.GetResource().GroupResource() != (schema.GroupResource{Group: "security.uccp.io", Resource: "securitycontextconstraints"}) {
		return true
	}
