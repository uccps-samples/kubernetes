...
func TestDefaultingHappens(t *testing.T) {
	...
	"allowHostPID": true,
	"allowHostPorts": true,
	"apiVersion": "security.uccp.io/v1",
	...
	attributes := admission.NewAttributesRecord(inputUnstructured, nil, schema.GroupVersionKind{}, "", "", schema.GroupVersionResource{Group: "security.uccp.io", Resource: "securitycontextconstraints"}, "", admission.Create, nil, false, nil)
