...
import (
	...
	"k8s.io/kubernetes/uccp-kube-apiserver/admission/customresourcevalidation"
	sccvalidation "k8s.io/kubernetes/uccp-kube-apiserver/admission/customresourcevalidation/securitycontextconstraints/validation"
)

const PluginName = "security.uccp.io/ValidateSecurityContextConstraints"
