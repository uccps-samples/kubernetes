...
import (
	...
	"k8s.io/klog/v2"
	"k8s.io/kubernetes/uccp-kube-apiserver/admission/network/apis/externalipranger"
	v1 "k8s.io/kubernetes/uccp-kube-apiserver/admission/network/apis/externalipranger/v1"
	kapi "k8s.io/kubernetes/pkg/apis/core"
	netutils "k8s.io/utils/net"
)

const ExternalIPPluginName = "network.uccp.io/ExternalIPRanger"

func RegisterExternalIP(plugins *admission.Plugins) {
	plugins.Register("network.uccp.io/ExternalIPRanger",
