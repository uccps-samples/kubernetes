...
import (
	...
	v1 "k8s.io/kubernetes/uccp-kube-apiserver/admission/network/apis/restrictedendpoints/v1"
)

const RestrictedEndpointsPluginName = "network.uccp.io/RestrictedEndpointsAdmission"
