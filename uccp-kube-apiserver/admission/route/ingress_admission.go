...
import (
	...
	v1 "k8s.io/kubernetes/uccp-kube-apiserver/admission/route/apis/ingressadmission/v1"
)

const (
	IngressAdmission = "route.uccp.io/IngressAdmission"
)
...
func (r *ingressAdmission) ValidateInitialization() error {
	if r.authorizer == nil {
		return fmt.Errorf("%s needs an Uccp Authorizer", IngressAdmission)
	}
	return nil
}
