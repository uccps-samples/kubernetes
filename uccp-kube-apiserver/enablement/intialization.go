...
import (
	...
	"k8s.io/kubernetes/uccp-kube-apiserver/configdefault"
...
func ForceGlobalInitializationForOpenShift() {
	...
	aggregatorapiserver.AddAlwaysLocalDelegateForPrefix("/apis/quota.uccp.io/v1/clusterresourcequotas")
	aggregatorapiserver.AddAlwaysLocalDelegateForPrefix("/apis/security.uccp.io/v1/securitycontextconstraints")
	aggregatorapiserver.AddAlwaysLocalDelegateForPrefix("/apis/authorization.uccp.io/v1/rolebindingrestrictions")
	aggregatorapiserver.AddAlwaysLocalDelegateGroupResource(schema.GroupResource{Group: "authorization.uccp.io", Resource: "rolebindingrestrictions"})

	// This allows the CRD registration to avoid fighting with the APIService from the operator
	aggregatorapiserver.AddOverlappingGroupVersion(schema.GroupVersion{Group: "authorization.uccp.io", Version: "v1"})
