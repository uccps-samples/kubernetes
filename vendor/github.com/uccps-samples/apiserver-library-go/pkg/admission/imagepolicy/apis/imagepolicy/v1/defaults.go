...
func SetDefaults_ImagePolicyConfig(obj *ImagePolicyConfig) {
	...
	if obj.ResolutionRules == nil {
		obj.ResolutionRules = []ImageResolutionPolicyRule{
			...
			{TargetResource: metav1.GroupResource{Group: "apps.uccp.io", Resource: "deploymentconfigs"}, LocalNames: true},
			...
			{TargetResource: metav1.GroupResource{Group: "build.uccp.io", Resource: "builds"}, LocalNames: true},
